        ...
        "stage_plan": [
            ...
            },
            {
                ...
                "command": (
                    ...
                    "assert int(report.get(\"complete\") or 0) >= 80, report\n"
                    ...
                    "by_name={pkg.get(\"name\", \"\"): pkg for pkg in packages}\n"
                    ...
                    "    if not item:\n"
                    "        missing.append(f\"{package}:missing\")\n"
                    "        continue\n"
    ...
    "stage_plan": [
        {
            ...
            "command": (
                ...
                "expected=\"${BKC_INPUT_EXPECTED_REPACK_COUNT:-1133}\"; low=\"${BKC_INPUT_SAFE_COUNT_MIN:-300}\"; high=\"${BKC_INPUT_SAFE_COUNT_MAX:-350}\"; "
                "ssh -i /app/keys/bkc_id_rsa -o IdentitiesOnly=yes -o StrictHostKeyChecking=accept-new -o UserKnownHostsFile=/app/runtime/known_hosts root@10.20.0.130 "
